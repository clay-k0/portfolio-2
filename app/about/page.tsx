        ...
        <div className='mt-20 pb-4 lg:mt-0 lg:pb-0'>
          <Card>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='relative flex flex-col justify-center px-6 py-10 pointer-events-none'>
                ...
                <div className='relative'>
                  <p className='text-zinc-400 mb-6'>
                    ...
                    student who is also learning web development. i'm currently
                    a sophomore at tidewater community college with one semester
                    ...
                    libraries/frameworks, i mainly use react and next.js, but
                    i'm currently learning svelte and sveltekit. in my free
                    time, i enjoy listening to music, collecting vinyl, spending
                    time with family and friends, cycling outdoors, and coding.
                    feel free to head to the{" "}
                    <Link
                      className='text-zinc-100 hover:underline pointer-events-auto'
                      href='/contact'
                    >
                      contact
                    </Link>{" "}
